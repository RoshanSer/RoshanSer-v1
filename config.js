...
module.exports = {
    ...
    SESSION: process.env.ROSHANSER_CODE === undefined ? '' : process.env.ROSHANSER_CODE,
    ...
    OA_NAME: process.env.DEPLOYER === undefined ? 'Roshan' : process.env.DEPLOYER,
    ALL: process.env.ALL_CAPTION === undefined ? 'Made By RoshanSer' : process.env.ALL_CAPTION,
    MENTION: process.env.TAG_REPLY === undefined ? '918848859106@s.whatsapp.net' : process.env.TAG_REPLY,
